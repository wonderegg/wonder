...
*/
contract WonderCrowdsale is Ownable {

    using SafeMath for uint;

    WonderToken public token = new WonderToken();
    ...
    function WonderCrowdsale(uint _icoStartTime, uint _icoEndTime, address _wallet) public {
        require (
          _icoStartTime > now &&
